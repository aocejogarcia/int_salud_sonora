...
openxlsx::write.xlsx(bol, 'datos/dengue/dengue nacional.xlsx', overwrite = T)
...
dengue_actual %>%
  ...
  openxlsx::write.xlsx('datos/dengue/Estudiados por municipio2.xlsx', overwrite = T)
...
dengue_actual %>%
  ...
  openxlsx::write.xlsx('datos/dengue/Positividad - estimados dengue.xlsx', overwrite = T)
...
dengue_actual %>% 
  ...
  arrange(semana) %>% 
  openxlsx::write.xlsx('datos/dengue/probables y confirmados.xlsx', overwrite = T)
...
ESTUDIADOS %>% 
  ...
  write.csv('datos/dengue/Estudiados_dengue.csv', fileEncoding = 'latin1')
